...
<body class="vertical-layout vertical-menu 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu" data-col="2-columns">
            ...
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="modern admin logo" src="{{asset('app-assets/images/logo/logo.png')}}">
                            <h3 class="brand-text">Emp System</h3>
                        </a></li>
            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    <ul class="nav navbar-nav mr-auto float-left">
                        ...
                        <li class="dropdown nav-item mega-dropdown d-none d-lg-block"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Emp System</a>
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">{{Auth::user()->firstname}} {{Auth::user()->lastname}}</span><span class="avatar avatar-online"><img src="{{asset('app-assets/images/portrait/small/avatar-s-19.png')}}" alt="avatar"><i></i></span></a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item "><a href="{{route('employees')}}"><i class="la la-home"></i><span class="menu-title" data-i18n="Dashboard">Employee Management</span></a>

                </li>
                <li class=" nav-item "><a href="index.html"><i class="la la-home"></i><span class="menu-title" data-i18n="Dashboard">System Management</span></a>
                    <ul class="menu-content">

                        <li><a class="menu-item" href="{{route('admin.department')}}"><i></i><span data-i18n="Department">Department</span></a>
                        </li>
                        <li><a class="menu-item" href="{{route('admin.state')}}"><i></i><span data-i18n="state">State</span></a>
                        </li>
                        <li><a class="menu-item" href="{{route('admin.city')}}"><i></i><span data-i18n="city">City</span></a>
                        </li>

                </li>
            </ul>
            </li>
            <li class=" nav-item "><a href="index.html"><i class="la la-home"></i><span class="menu-title" data-i18n="Dashboard">User management</span></a>
                <ul class="menu-content">

                    <li><a class="menu-item" href="dashboard-sales.html"><i></i><span data-i18n="User">User</span></a>
                    </li>

            </li>
            </ul>
            </li>
            {{-- <li  @if(Request::is('menu/*')||Request::is('menu')) class="active nav-item" @else class="nav-item" @endif><a href="{{route('menu.index')}}" ><i class="la la-sitemap"></i><span class="menu-title" data-i18n="Menu">Menu</span></a> --}}
            </li>
            </ul>
        </div>
    </div>
    ...
    <script>
        $(function() {
            ...
            toastr.success('Great!', '{{ session('
                success ') }}', {
                    positionClass: "toast-top-right"
                })
            @endif
            @if(session('error'))
            toastr.error('Great!', '{{ session('
                success ') }}', {
                    positionClass: "toast-top-right"
                })
            @endif
